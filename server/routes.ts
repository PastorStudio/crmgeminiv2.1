...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.post("/api/gemini/analyze-lead", async (req: Request, res: Response) => {
    try {
      ...
      const aiAnalysis = {
        ...
        enrichmentData: {
          interests: ["AI Technology", "SaaS Solutions", "Cloud Infrastructure"],
    ...
    try {
      ...
      switch (messageType) {
        case "follow-up":
          ...
          break;
        case "proposal":
          generatedContent = `Dear ${lead.fullName},\n\nBased on our conversation, I've prepared a custom proposal for ${lead.company}. Our solution will address your specific needs and help you achieve your goals.\n\nLet me know if you'd like to discuss this proposal in more detail.\n\nBest regards,\n[Your Name]`;
          break;
        case "meeting-request":
          generatedContent = `Hi ${lead.fullName},\n\nI would love to schedule a meeting to discuss how our services can benefit ${lead.company}. Would you be available for a 30-minute call next week?\n\nBest regards,\n[Your Name]`;
          break;
        default:
  ...
  app.post("/api/gemini/chat", async (req: Request, res: Response) => {
    try {
      ...
      const response = {
        role: "assistant",
        content: "I'm your Gemini AI assistant. I can help with lead analysis, content generation, and providing insights for your CRM. What specific task would you like assistance with today?"
      };
