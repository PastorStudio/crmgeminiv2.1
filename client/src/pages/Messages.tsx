...
export default function Messages() {
  ...
  const [interfaceMode, setInterfaceMode] = useState<"whatsapp" | "default">("whatsapp");
          ...
          <div className="mb-6 flex justify-between items-center">
            ...
            <div className="space-y-2">
              ...
              <button 
                ...
                className="flex items-center gap-2 text-sm text-green-600 hover:text-green-700 bg-green-50 hover:bg-green-100 rounded-md px-3 py-1.5"
              >
        ...
        <>
          <div className="mb-6 flex justify-between items-center">
            <div className="flex items-center gap-4">
              <button 
                onClick={() => setInterfaceMode("default")}
                className="flex items-center gap-2 text-sm bg-white border border-gray-200 hover:bg-gray-50 rounded-md px-3 py-1.5"
              >
