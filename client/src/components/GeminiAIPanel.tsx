...
export function GeminiAIPanel() {
  ...
  const checkGeminiKeyStatus = async () => {
    try {
      console.log('🔑 Verificando estado de Gemini Pro automático...');
      ...
      // Verificar si el sistema automático está funcionando
      const isValid = data.success && (data.hasValidKey || data.autoGenerated);
      
      console.log('✅ Estado final de Gemini:', isValid);
      setGeminiKeyStatus(isValid);
    } catch (error) {
